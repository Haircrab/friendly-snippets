...
> {
>   "L3MON4D3/LuaSnip",
>   dependencies = { "Haircrab/friendly-snippets" },
> }
> ```
...
```lua
use "Haircrab/friendly-snippets"
```

### With vim-plug

```vim
Plug "Haircrab/friendly-snippets"
```

### With coc.nvim

```vim
:CocInstall https://github.com/Haircrab/friendly-snippets@main
```
